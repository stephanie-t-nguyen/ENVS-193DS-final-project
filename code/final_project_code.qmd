...
**Figure ???**. Diagnostic Plots for Kangaroo Rat Data
...
```{r}
#Statistical checks
kr_model <- lm(seeds ~ loc, data = kangaroo_rat)
...
rstatix::kruskal_effsize(seeds ~ loc, data = kangaroo_rat, conf.level = 0.95) |> 
...
**Figure ???**. Effect Size of Kruskal Wallis Test
